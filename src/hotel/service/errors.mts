 ...
 * von Hotels, z.B. beim DB-Zugriff.
 * @packageDocumentation
 */

/**
 * Error-Klasse für ein nicht gefundenes Hotel.
 */
export class NotFoundError extends Error {}

/**
 * Error-Klasse für eine bereits existierendes Hotel.
 */
export class HotelExistsError extends Error {
    readonly hotel: string | undefined;

    constructor(hotel: string | undefined) {
        super(`Das Hotel ${hotel} existiert bereits.`);
        this.hotel = hotel;
    }
}
